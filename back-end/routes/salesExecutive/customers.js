 ...
 *     tags: [Sales Executive - Customers]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 */
router.get('/', auth, salesExecutiveController.getAssignedCustomers);

/**
 * @swagger
 * /sales-executive/customers/{id}:
 *   get:
 ...
 *         description: Server error
 */
router.get('/:id', auth, salesExecutiveController.getCustomerById);

/**
 * @swagger
 * /sales-executive/customers/{id}/visits:
 *   post:
 ...
 *         description: Server error
 */
router.post('/:id/visits', auth, salesExecutiveController.createVisitReport);

/**
 * @swagger
 * /sales-executive/customers/visits:
 *   get:
 ...
 *         description: Server error
 */
router.get('/visits', auth, salesExecutiveController.getVisitReports);
