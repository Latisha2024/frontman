        ...
        child: ListView(
          ...
          children: [
            ...
            ExpansionTile(
              ...
              children: [
                _drawerItem(context, "Browse Product Catalog", const BrowseCatalogPage()),
                _drawerItem(context, "Get Product Catalog", const GetCatalogPage()),
                _drawerItem(context, "Add Products to Cart", const AddToCartPage()),
                _drawerItem(context, "Apply Promo Code", const ApplyPromoPage()),
          ...
          children: [
            ...
            Expanded(
              child: GridView.count(
                ...
                mainAxisSpacing: 12,
                children: [
                  _dashboardButton(context, "Browse Catalog", Icons.list, const BrowseCatalogPage()),
                  _dashboardButton(context, "Get Catalog", Icons.download, const GetCatalogPage()),
                  _dashboardButton(context, "Add to Cart", Icons.add_shopping_cart, const AddToCartPage()),
                  _dashboardButton(context, "Apply Promo", Icons.percent, const ApplyPromoPage()),
