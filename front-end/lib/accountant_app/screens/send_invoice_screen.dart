...
class _SendInvoiceScreenState extends State<SendInvoiceScreen> {
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      child: Text(
                        // CORRECTED: Added a check to prevent crash on empty clientName
                        invoice.clientName.isNotEmpty ? invoice.clientName[0].toUpperCase() : '?',
  ...
  void _sendInvoice() {
    ...
    .then((_) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to send invoice: $error'),
  ...
  // This navigation drawer is included for completeness.
